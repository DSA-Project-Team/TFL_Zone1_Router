...
namespace testing_and_benchmarking.Utilities
{
    public class ConsoleTable
    {
        ...
        public void Write(ConsoleFormat format = ConsoleFormat.Default)
        {
            switch (format)
            {
                case ConsoleFormat.Default:
                    Options.OutputTo.WriteLine(ToString());
                    break;
                case ConsoleFormat.MarkDown:
                    Options.OutputTo.WriteLine(ToMarkDownString());
                    break;
                case ConsoleFormat.Alternative:
                    Options.OutputTo.WriteLine(ToStringAlternative());
                    break;
                case ConsoleFormat.Minimal:
